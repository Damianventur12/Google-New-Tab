...
export class DriveHandlerRemote {
     ...
     */
    getFiles() {
        return this.proxy.sendMessage(0, DriveHandler_GetFiles_ParamsSpec.$, DriveHandler_GetFiles_ResponseParamsSpec.$, []);
    }
    /**
     */
    dismissModule() {
        this.proxy.sendMessage(1, DriveHandler_DismissModule_ParamsSpec.$, null, []);
    }
    /**
     */
    restoreModule() {
        this.proxy.sendMessage(2, DriveHandler_RestoreModule_ParamsSpec.$, null, []);
    }
}
/**
...
export class DriveHandlerReceiver {
    ...
    constructor(impl) {
        ...
        this.helper_internal_.registerHandler(0, DriveHandler_GetFiles_ParamsSpec.$, DriveHandler_GetFiles_ResponseParamsSpec.$, impl.getFiles.bind(impl));
        this.helper_internal_.registerHandler(1, DriveHandler_DismissModule_ParamsSpec.$, null, impl.dismissModule.bind(impl));
        this.helper_internal_.registerHandler(2, DriveHandler_RestoreModule_ParamsSpec.$, null, impl.restoreModule.bind(impl));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
...
export class DriveHandlerCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(0, DriveHandler_GetFiles_ParamsSpec.$, DriveHandler_GetFiles_ResponseParamsSpec.$, this.getFiles.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.dismissModule =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1, DriveHandler_DismissModule_ParamsSpec.$, null, this.dismissModule.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.restoreModule =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(2, DriveHandler_RestoreModule_ParamsSpec.$, null, this.restoreModule.createReceiverHandler(false /* expectsResponse */));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter();
    }
    /**
