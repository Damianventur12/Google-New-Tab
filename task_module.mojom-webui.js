...
export class TaskModuleHandlerRemote {
     ...
     */
    getPrimaryTask() {
        return this.proxy.sendMessage(0, TaskModuleHandler_GetPrimaryTask_ParamsSpec.$, TaskModuleHandler_GetPrimaryTask_ResponseParamsSpec.$, []);
    }
    /**
     * @param { !string } taskName
     */
    dismissTask(taskName) {
        this.proxy.sendMessage(1, TaskModuleHandler_DismissTask_ParamsSpec.$, null, [
            taskName
        ]);
    }
    /**
     ...
     */
    restoreTask(taskName) {
        this.proxy.sendMessage(2, TaskModuleHandler_RestoreTask_ParamsSpec.$, null, [
            taskName
        ]);
    }
    /**
     ...
     */
    onTaskItemClicked(index) {
        this.proxy.sendMessage(3, TaskModuleHandler_OnTaskItemClicked_ParamsSpec.$, null, [
            index
        ]);
    }
    /**
     ...
     */
    onRelatedSearchClicked(index) {
        this.proxy.sendMessage(4, TaskModuleHandler_OnRelatedSearchClicked_ParamsSpec.$, null, [
            index
        ]);
    }
}
...
export class TaskModuleHandlerReceiver {
    ...
    constructor(impl) {
        ...
        this.helper_internal_.registerHandler(0, TaskModuleHandler_GetPrimaryTask_ParamsSpec.$, TaskModuleHandler_GetPrimaryTask_ResponseParamsSpec.$, impl.getPrimaryTask.bind(impl));
        this.helper_internal_.registerHandler(1, TaskModuleHandler_DismissTask_ParamsSpec.$, null, impl.dismissTask.bind(impl));
        this.helper_internal_.registerHandler(2, TaskModuleHandler_RestoreTask_ParamsSpec.$, null, impl.restoreTask.bind(impl));
        this.helper_internal_.registerHandler(3, TaskModuleHandler_OnTaskItemClicked_ParamsSpec.$, null, impl.onTaskItemClicked.bind(impl));
        this.helper_internal_.registerHandler(4, TaskModuleHandler_OnRelatedSearchClicked_ParamsSpec.$, null, impl.onRelatedSearchClicked.bind(impl));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
...
export class TaskModuleHandlerCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(0, TaskModuleHandler_GetPrimaryTask_ParamsSpec.$, TaskModuleHandler_GetPrimaryTask_ResponseParamsSpec.$, this.getPrimaryTask.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.dismissTask =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1, TaskModuleHandler_DismissTask_ParamsSpec.$, null, this.dismissTask.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.restoreTask =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(2, TaskModuleHandler_RestoreTask_ParamsSpec.$, null, this.restoreTask.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.onTaskItemClicked =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(3, TaskModuleHandler_OnTaskItemClicked_ParamsSpec.$, null, this.onTaskItemClicked.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.onRelatedSearchClicked =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(4, TaskModuleHandler_OnRelatedSearchClicked_ParamsSpec.$, null, this.onRelatedSearchClicked.createReceiverHandler(false /* expectsResponse */));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter();
    }
    /**
