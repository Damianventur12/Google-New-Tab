...
<cr-dialog id="dialog" show-on-attach="">
  ...
  <div slot="body">
    ...
    <cr-input readonly="" label="Enlace del doodle" id="url" value="[[url.url]]">
  ...
  <dom-if if="[[lazyRender_]]" on-dom-change="onLazyRendered_">
    <template>
      ...
      <div id="customizeButtonContainer">
        <cr-button id="customizeButton" on-click="onCustomizeClick_" title="Personalizar esta página">
