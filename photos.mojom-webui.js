...
export class PhotosHandlerRemote {
     ...
     */
    getMemories() {
        return this.proxy.sendMessage(0, PhotosHandler_GetMemories_ParamsSpec.$, PhotosHandler_GetMemories_ResponseParamsSpec.$, []);
    }
    /**
     */
    dismissModule() {
        this.proxy.sendMessage(1, PhotosHandler_DismissModule_ParamsSpec.$, null, []);
    }
    /**
     */
    restoreModule() {
        this.proxy.sendMessage(2, PhotosHandler_RestoreModule_ParamsSpec.$, null, []);
    }
    /**
     * @return {!Promise<{
          showOptInScreen: !boolean,
     ...
     */
    shouldShowOptInScreen() {
        return this.proxy.sendMessage(3, PhotosHandler_ShouldShowOptInScreen_ParamsSpec.$, PhotosHandler_ShouldShowOptInScreen_ResponseParamsSpec.$, []);
    }
    /**
     * @param { !boolean } accept
     */
    onUserOptIn(accept) {
        this.proxy.sendMessage(4, PhotosHandler_OnUserOptIn_ParamsSpec.$, null, [
            accept
        ]);
    }
    /**
     */
    onMemoryOpen() {
        this.proxy.sendMessage(5, PhotosHandler_OnMemoryOpen_ParamsSpec.$, null, []);
    }
    /**
     * @return {!Promise<{
          showSoftOptOutButton: !boolean,
     ...
     */
    shouldShowSoftOptOutButton() {
        return this.proxy.sendMessage(6, PhotosHandler_ShouldShowSoftOptOutButton_ParamsSpec.$, PhotosHandler_ShouldShowSoftOptOutButton_ResponseParamsSpec.$, []);
    }
    /**
     */
    softOptOut() {
        this.proxy.sendMessage(7, PhotosHandler_SoftOptOut_ParamsSpec.$, null, []);
    }
    /**
     * @param { !Array<!Memory> } memories
     * @return {!Promise<{
     ...
     */
    getOptInTitleText(memories) {
        return this.proxy.sendMessage(8, PhotosHandler_GetOptInTitleText_ParamsSpec.$, PhotosHandler_GetOptInTitleText_ResponseParamsSpec.$, [
            memories
        ]);
    }
}
...
export class PhotosHandlerReceiver {
    ...
    constructor(impl) {
        ...
        this.helper_internal_.registerHandler(0, PhotosHandler_GetMemories_ParamsSpec.$, PhotosHandler_GetMemories_ResponseParamsSpec.$, impl.getMemories.bind(impl));
        this.helper_internal_.registerHandler(1, PhotosHandler_DismissModule_ParamsSpec.$, null, impl.dismissModule.bind(impl));
        this.helper_internal_.registerHandler(2, PhotosHandler_RestoreModule_ParamsSpec.$, null, impl.restoreModule.bind(impl));
        this.helper_internal_.registerHandler(3, PhotosHandler_ShouldShowOptInScreen_ParamsSpec.$, PhotosHandler_ShouldShowOptInScreen_ResponseParamsSpec.$, impl.shouldShowOptInScreen.bind(impl));
        this.helper_internal_.registerHandler(4, PhotosHandler_OnUserOptIn_ParamsSpec.$, null, impl.onUserOptIn.bind(impl));
        this.helper_internal_.registerHandler(5, PhotosHandler_OnMemoryOpen_ParamsSpec.$, null, impl.onMemoryOpen.bind(impl));
        this.helper_internal_.registerHandler(6, PhotosHandler_ShouldShowSoftOptOutButton_ParamsSpec.$, PhotosHandler_ShouldShowSoftOptOutButton_ResponseParamsSpec.$, impl.shouldShowSoftOptOutButton.bind(impl));
        this.helper_internal_.registerHandler(7, PhotosHandler_SoftOptOut_ParamsSpec.$, null, impl.softOptOut.bind(impl));
        this.helper_internal_.registerHandler(8, PhotosHandler_GetOptInTitleText_ParamsSpec.$, PhotosHandler_GetOptInTitleText_ResponseParamsSpec.$, impl.getOptInTitleText.bind(impl));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
...
export class PhotosHandlerCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(0, PhotosHandler_GetMemories_ParamsSpec.$, PhotosHandler_GetMemories_ResponseParamsSpec.$, this.getMemories.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.dismissModule =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1, PhotosHandler_DismissModule_ParamsSpec.$, null, this.dismissModule.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.restoreModule =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(2, PhotosHandler_RestoreModule_ParamsSpec.$, null, this.restoreModule.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.shouldShowOptInScreen =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(3, PhotosHandler_ShouldShowOptInScreen_ParamsSpec.$, PhotosHandler_ShouldShowOptInScreen_ResponseParamsSpec.$, this.shouldShowOptInScreen.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.onUserOptIn =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(4, PhotosHandler_OnUserOptIn_ParamsSpec.$, null, this.onUserOptIn.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.onMemoryOpen =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(5, PhotosHandler_OnMemoryOpen_ParamsSpec.$, null, this.onMemoryOpen.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.shouldShowSoftOptOutButton =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(6, PhotosHandler_ShouldShowSoftOptOutButton_ParamsSpec.$, PhotosHandler_ShouldShowSoftOptOutButton_ResponseParamsSpec.$, this.shouldShowSoftOptOutButton.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.softOptOut =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(7, PhotosHandler_SoftOptOut_ParamsSpec.$, null, this.softOptOut.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.getOptInTitleText =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(8, PhotosHandler_GetOptInTitleText_ParamsSpec.$, PhotosHandler_GetOptInTitleText_ResponseParamsSpec.$, this.getOptInTitleText.createReceiverHandler(true /* expectsResponse */));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter();
    }
    /**
