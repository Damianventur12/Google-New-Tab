...
<div id="backgroundsDisabled" hidden$="[[!customBackgroundDisabledByPolicy_]]">
  ...
  <div id="backgroundsDisabledTitle">El administrador ha desactivado los fondos personalizados</div>
</div>
<cr-grid id="collections" columns="3" hidden="[[!showBackgroundSelection_]]">
  <div id="uploadFromDevice" class="tile" role="button" on-click="onUploadFromDeviceClick_" tabindex="0">
    <div class$="[[getCustomBackgroundClass_(theme, backgroundSelection)]]">
      ...
      <div id="uploadFromDeviceImage">
        ...
        <div class="label">Subir desde dispositivo</div>
      </div>
  ...
  <div id="noBackground" class="tile" role="button" on-click="onDefaultClick_" tabindex="0">
    ...
    <div class="label">Chrome clásico</div>
  </div>
...
<div id="options">
  <div id="optionCustomLinks" class$="option [[getCustomLinksSelected_(customLinksEnabled_, hide_)]]">
    ...
    <div class="option-description">Tú gestionas los accesos directos</div>
  </div>
  <div id="optionMostVisited" class$="option [[getMostVisitedSelected_(customLinksEnabled_, hide_)]]">
    <cr-button id="optionMostVisitedButton" class="option-image" tabindex="0" aria-pressed$="[[getMostVisitedAriaPressed_(customLinksEnabled_,
            hide_)]]" title="Sitios web más visitados" on-click="onMostVisitedClick_" on-keydown="onMostVistedKey" noink="">
      <div class="option-icon"></div>
      <div class="option-mini">
        <ntp-mini-page single-colored-logo=""></ntp-mini-page>
      </div>
    ...
    <div class="option-title">Sitios web más visitados</div>
    <div class="option-description">Se sugieren accesos directos a los sitios web que visitas más a menudo</div>
  </div>
</div>
<div id="hide" class$="[[getHideClass_(hide_)]]">
  ...
  <div id="hideTitleContainer">
    ...
    <div id="hideDescription" class="option-description">
      No mostrar accesos directos en esta página
    </div>
  </div>
    ...
    <div class="toggle-section">
      ...
      <template is="dom-if" if="[[showDiscountToggle_(item.id, item.checked, discountToggleEligible_)]]">
        <div class="discount-toggle-row">
          ...
          <cr-toggle checked="{{discountToggle_.enabled}}" title="Conseguir descuentos"></cr-toggle>
        </div>
      </template>
    </div>
  </template>
...
<div id="titleContainer">
  ...
  <template is="dom-if" if="[[!hideMenuButton]]" restamp="">
    <cr-icon-button id="menuButton" title="Más acciones" class="icon-more-vert" on-click="onMenuButtonClick_">
    </cr-icon-button>
  </template>
</div>
    ...
    <div id="cartCarousel">
          ...
          <template is="dom-if" if="[[!discountConsentHasTwoSteps_]]" restamp="">
            <div id="consentCard">
              ...
              <span id="consentContent">
                ¿Permitir que Google busque descuentos personalizados para tus carritos?
              </span>
      ...
      <template id="cartItemRepeat" is="dom-repeat" items="[[cartItems]]">
        <div class="cart-container">
          ...
          <cr-icon-button class="icon-more-vert" title="Más acciones" on-click="onCartMenuButtonClick_">
          </cr-icon-button>
        </div>
      </template>
      ...
      <div id="optInContent">
        <div>
          ...
          <span id="optInTitleDesc">
            Explora tus recuerdos de Google Fotos siempre que hayas iniciado sesión.
          </span>
        </div>
        <div>
  ...
  <template id="memoriesElement" is="dom-if" if="[[!showOptInScreen]]">
    ...
    <template id="exploreCardElement" is="dom-if" if="[[showExploreMore_]]">
      <a href="https://photos.google.com?referrer=CHROME_NTP" class="card" on-click="onMemoryClick_" target="_blank" id="exploreCard">
        ...
        <div id="exploreText">
          Revive más recuerdos en Google Fotos
        </div>
      </a>
    </template>
  </template>
  ...
  <div slot="title">
    ...
    <div id="title">
      ...
      <div id="titleNavigation" hidden="[[!showTitleNavigation_]]">
        <cr-icon-button id="backButton" class="icon-arrow-back" on-click="onBackClick_" title="Volver">
        </cr-icon-button>
...
<cr-dialog id="dialog" show-close-button="" on-cancel="onDismissClick_" show-on-attach="" close-text="Cerrar">
  ...
  <div slot="body">
    <div id="content-container" tabindex="0">
      <div id="content-title">¿Obtener descuentos?</div>
      <div id="content">¿Permitir que Google use tu carrito para buscar descuentos disponibles?</div>
    </div>
  ...
  <template is="dom-if" if="[[modulesFreShown]]">
    <div id="firstRunExperience">
      ...
      <div class="first-run-experience-body">
        Elige tarjetas que te mantengan al día de las cosas que te importan.
      </div>
      <div class="first-run-experience-body">
        Consulta todas las opciones de las tarjetas en <a is="action-link" id="customizeChromeLink" tabIndex=0 on-click="onCustomizeModuleFre_">Personalizar Chrome</a>.
      </div>
...
<cr-toast id="removeModuleToast" duration="10000">
  ...
  <cr-button id="undoRemoveModuleButton" aria-label="Pulsa Ctrl + Z para deshacer" on-click="onUndoRemoveModuleButtonClick_">
    Deshacer
  </cr-button>
</cr-toast>
<cr-toast id="removeModuleFreToast" duration="10000">
  ...
  <cr-button id="undoRemoveModuleFreButton" aria-label="Pulsa Ctrl + Z para deshacer" on-click="onUndoRemoveModuleFreButtonClick_">
    Deshacer
  </cr-button>
</cr-toast>
<!--_html_template_end_-->`}// Copyright 2021 The Chromium Authors. All rights reserved.
